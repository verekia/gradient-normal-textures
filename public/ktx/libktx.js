  ...
  return async function (moduleArg = {}) {
    ...
    async function createWasm() {
      function receiveInstance(instance, module) {
        ...
        wasmMemory = wasmExports['bf']
        updateMemoryViews()
        wasmTable = wasmExports['ff']
    ...
    function assignWasmExports(wasmExports) {
      ...
      _malloc = wasmExports['ef']
      _free = wasmExports['gf']
    }
    var wasmImports = {
      u: ___cxa_throw,
      ...
      _a: ___syscall_openat,
      bb: __abort_js,
      Ha: __embind_finalize_value_object,
      ...
      n: __embind_register_constant,
      Fb: __embind_register_emval,
      ...
      _b: __embind_register_std_string,
      t: __embind_register_std_wstring,
      hd: __embind_register_value_object,
      s: __embind_register_value_object_field,
      Yc: __embind_register_void,
      ...
      ye: __emval_new_object,
      e: __emval_run_destructors,
      A: __emval_set_property,
      Pa: __tzset_js,
      $a: _emscripten_date_now,
      Ta: _emscripten_get_heap_max,
      wa: _emscripten_glActiveTexture,
      va: _emscripten_glAttachShader,
      Zc: _emscripten_glBeginQuery,
      Na: _emscripten_glBeginQueryEXT,
      Ac: _emscripten_glBeginTransformFeedback,
      ua: _emscripten_glBindAttribLocation,
      ta: _emscripten_glBindBuffer,
      xc: _emscripten_glBindBufferBase,
      yc: _emscripten_glBindBufferRange,
      sa: _emscripten_glBindFramebuffer,
      ra: _emscripten_glBindRenderbuffer,
      Db: _emscripten_glBindSampler,
      qa: _emscripten_glBindTexture,
      vb: _emscripten_glBindTransformFeedback,
      Fc: _emscripten_glBindVertexArray,
      Ea: _emscripten_glBindVertexArrayOES,
      pa: _emscripten_glBlendColor,
      oa: _emscripten_glBlendEquation,
      na: _emscripten_glBlendEquationSeparate,
      ma: _emscripten_glBlendFunc,
      la: _emscripten_glBlendFuncSeparate,
      Kc: _emscripten_glBlitFramebuffer,
      ka: _emscripten_glBufferData,
      ja: _emscripten_glBufferSubData,
      ia: _emscripten_glCheckFramebufferStatus,
      ha: _emscripten_glClear,
      ...
      ga: _emscripten_glClearColor,
      fa: _emscripten_glClearDepthf,
      ea: _emscripten_glClearStencil,
      Nb: _emscripten_glClientWaitSync,
      od: _emscripten_glClipControlEXT,
      da: _emscripten_glColorMask,
      ca: _emscripten_glCompileShader,
      ba: _emscripten_glCompressedTexImage2D,
      cd: _emscripten_glCompressedTexImage3D,
      aa: _emscripten_glCompressedTexSubImage2D,
      ...
      Z: _emscripten_glCreateProgram,
      Y: _emscripten_glCreateShader,
      X: _emscripten_glCullFace,
      W: _emscripten_glDeleteBuffers,
      V: _emscripten_glDeleteFramebuffers,
      U: _emscripten_glDeleteProgram,
      $c: _emscripten_glDeleteQueries,
      Ua: _emscripten_glDeleteQueriesEXT,
      T: _emscripten_glDeleteRenderbuffers,
      Gb: _emscripten_glDeleteSamplers,
      S: _emscripten_glDeleteShader,
      Ob: _emscripten_glDeleteSync,
      R: _emscripten_glDeleteTextures,
      ub: _emscripten_glDeleteTransformFeedbacks,
      Ec: _emscripten_glDeleteVertexArrays,
      Da: _emscripten_glDeleteVertexArraysOES,
      Q: _emscripten_glDepthFunc,
      P: _emscripten_glDepthMask,
      O: _emscripten_glDepthRangef,
      N: _emscripten_glDetachShader,
      M: _emscripten_glDisable,
      L: _emscripten_glDisableVertexAttribArray,
      K: _emscripten_glDrawArrays,
      Sb: _emscripten_glDrawArraysInstanced,
      za: _emscripten_glDrawArraysInstancedANGLE,
      eb: _emscripten_glDrawArraysInstancedARB,
      ld: _emscripten_glDrawArraysInstancedEXT,
      fb: _emscripten_glDrawArraysInstancedNV,
      Sc: _emscripten_glDrawBuffers,
      jd: _emscripten_glDrawBuffersEXT,
      Aa: _emscripten_glDrawBuffersWEBGL,
      J: _emscripten_glDrawElements,
      Rb: _emscripten_glDrawElementsInstanced,
      ya: _emscripten_glDrawElementsInstancedANGLE,
      ...
      Xc: _emscripten_glEndQuery,
      Ma: _emscripten_glEndQueryEXT,
      zc: _emscripten_glEndTransformFeedback,
      Qb: _emscripten_glFenceSync,
      G: _emscripten_glFinish,
      F: _emscripten_glFlush,
      Gc: _emscripten_glFlushMappedBufferRange,
      E: _emscripten_glFramebufferRenderbuffer,
      D: _emscripten_glFramebufferTexture2D,
      Ic: _emscripten_glFramebufferTextureLayer,
      C: _emscripten_glFrontFace,
      B: _emscripten_glGenBuffers,
      $e: _emscripten_glGenFramebuffers,
      ad: _emscripten_glGenQueries,
      ab: _emscripten_glGenQueriesEXT,
      ...
      Dc: _emscripten_glGenVertexArrays,
      Ca: _emscripten_glGenVertexArraysOES,
      ...
      Ga: _emscripten_glGetQueryObjecti64vEXT,
      Ja: _emscripten_glGetQueryObjectivEXT,
      Fa: _emscripten_glGetQueryObjectui64vEXT,
      Vc: _emscripten_glGetQueryObjectuiv,
      Ia: _emscripten_glGetQueryObjectuivEXT,
      Wc: _emscripten_glGetQueryiv,
      Ka: _emscripten_glGetQueryivEXT,
      ...
      nc: _emscripten_glGetUniformuiv,
      ...
      Cc: _emscripten_glIsVertexArray,
      Ba: _emscripten_glIsVertexArrayOES,
      pe: _emscripten_glLineWidth,
      oe: _emscripten_glLinkProgram,
      Hc: _emscripten_glMapBufferRange,
      rb: _emscripten_glPauseTransformFeedback,
      ne: _emscripten_glPixelStorei,
      nd: _emscripten_glPolygonModeWEBGL,
      me: _emscripten_glPolygonOffset,
      pd: _emscripten_glPolygonOffsetClampEXT,
      ob: _emscripten_glProgramBinary,
      nb: _emscripten_glProgramParameteri,
      La: _emscripten_glQueryCounterEXT,
      id: _emscripten_glReadBuffer,
      le: _emscripten_glReadPixels,
      ke: _emscripten_glReleaseShaderCompiler,
      je: _emscripten_glRenderbufferStorage,
      Jc: _emscripten_glRenderbufferStorageMultisample,
      qb: _emscripten_glResumeTransformFeedback,
      ie: _emscripten_glSampleCoverage,
      ...
      lc: _emscripten_glUniform1ui,
      hc: _emscripten_glUniform1uiv,
      Qd: _emscripten_glUniform2f,
      Pd: _emscripten_glUniform2fv,
      Od: _emscripten_glUniform2i,
      Nd: _emscripten_glUniform2iv,
      kc: _emscripten_glUniform2ui,
      gc: _emscripten_glUniform2uiv,
      Md: _emscripten_glUniform3f,
      Ld: _emscripten_glUniform3fv,
      Kd: _emscripten_glUniform3i,
      Jd: _emscripten_glUniform3iv,
      jc: _emscripten_glUniform3ui,
      fc: _emscripten_glUniform3uiv,
      Id: _emscripten_glUniform4f,
      Hd: _emscripten_glUniform4fv,
      Gd: _emscripten_glUniform4i,
      Fd: _emscripten_glUniform4iv,
      ic: _emscripten_glUniform4ui,
      ec: _emscripten_glUniform4uiv,
      Tb: _emscripten_glUniformBlockBinding,
      Ed: _emscripten_glUniformMatrix2fv,
      Rc: _emscripten_glUniformMatrix2x3fv,
      Pc: _emscripten_glUniformMatrix2x4fv,
      Dd: _emscripten_glUniformMatrix3fv,
      Qc: _emscripten_glUniformMatrix3x2fv,
      Mc: _emscripten_glUniformMatrix3x4fv,
      Cd: _emscripten_glUniformMatrix4fv,
      Oc: _emscripten_glUniformMatrix4x2fv,
      Lc: _emscripten_glUniformMatrix4x3fv,
      Uc: _emscripten_glUnmapBuffer,
      Bd: _emscripten_glUseProgram,
      Ad: _emscripten_glValidateProgram,
      ...
      vd: _emscripten_glVertexAttrib3f,
      ...
      xa: _emscripten_glVertexAttribDivisorANGLE,
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createKtxModule
  module.exports.default = createKtxModule
} else if (typeof define === 'function' && define['amd']) define([], () => createKtxModule)
// -*- tab-width: 4; -*-
...
var LIBKTX
if (typeof createKtxReadModule === 'function') LIBKTX = createKtxReadModule
else LIBKTX = createKtxModule
